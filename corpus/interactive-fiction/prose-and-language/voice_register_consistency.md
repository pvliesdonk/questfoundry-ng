...
- [[Narrative & Game Design/Interactive Fiction/prose-and-language/narrative_point_of_view|Narrative Point of View]] — POV selection and maintenance
- [[Narrative & Game Design/Interactive Fiction/craft-foundations/diegetic_design|Diegetic Design]] — Player-facing voice consistency
- [[Narrative & Game Design/Interactive Fiction/craft-foundations/collaborative_if_writing|Collaborative IF Writing]] -- techniques for keeping one voice across many writers (style guides, voice editor, sample passages)
- [[Narrative & Game Design/Interactive Fiction/prose-and-language/subtext_and_implication|Subtext and Implication]] -- register shifts as a subtext signal (a character formality cracking under pressure)
