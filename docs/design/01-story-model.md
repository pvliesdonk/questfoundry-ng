...
DREAM: the story **title** (reader-facing, generated by DREAM from the
premise or kept if the author set it — distinct from `project.name`, which
is an administrative label; exports fall back to the name when the title is
blank), genre/subgenre, tone, themes, audience, content boundaries
